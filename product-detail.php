  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <div>
            <img src="assets/slider/aadharimages/aadhar1.png" width="100%" id="ProductImg">


            <div class="small-img-row">
              <div class="small-img-col">
                <img src="assets/slider/aadharimages/aadhar2.png" width="100%" class="small-img">
              </div>

              <div class="small-img-col">
                <img src="assets/slider/aadharimages/aadhar3.png" width="100%" class="small-img">
              </div>

              <div class="small-img-col">
                <img src="assets/slider/aadharimages/aadhar4.png" width="100%" class="small-img">
              </div>

              <div class="small-img-col">
                <img src="assets/slider/aadharimages/aadhar1.png" width="100%" class="small-img">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-2 ">
          ...
          <?php endif ?>
          <p>Home / aadhar pvc card</p>
          <h1>Adhar Pvc Card Print </h1>
          <h4> Price: 50 &#8377;</h4>
          <a href="https://wa.me/916204616951" class="whatsapp-dir-btn"><i class="fa fa-whatsapp"></i> Direct
            Order</a><br><br>
          <i class="fa fa-star"></i><label>Upload Your Aadhar File</label><br>
          <div>
            <?php
            ...
            $random = $emp.$number  ;
          ?>
            <form action="php2/submit.php" method="post" enctype="multipart/form-data">
            <input  hidden type="text" id="demo" name="date"></p>
                      <script>
                         const d = new Date();
                         document.getElementById("demo").value = d;
                         </script>
              <input hidden type="text" class="form-control" name="printtype" value="Aadhar PVC Card Print"
                readonly>
