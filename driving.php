  ...
  <body>
    ...
    <div class="small-container single-product">
      <div class="row">
        <div class="col-2">
          <div>
            <img src="assets/img/slide2.jpg" width="100%" id="ProductImg">
        ...
        <div class="col-2 ">
          ...
          <?php endif ?>
          <p>Home / DRIVING LICENSE Pvc Card</p>
          ...
          <i class="fa fa-star"></i><label>Upload Your DRIVING LICENSE File</label><br>
          ...
          ?>
            ...
            <input  hidden type="text" id="demo" name="date"></p>
              ...
              <input hidden type="text" class="form-control" name="printtype" value="DRIVING LICENSE PVC Card Print"
                readonly>
            ...
            <p class="upload-p">We Request you to send us DRIVING LICENSE pdf file </p>
